...
$lang['Open Instagram page in a new tab'] = '在新的标签页打开Instagram';
$lang['Photo "%s" imported'] = '图片"%s"已导入';
$lang['Please fill your API keys on the configuration tab'] = '请在配置选项卡上填写您的API keys';
$lang['Processing...'] = '处理中...';
$lang['Successfully logged in to you Instagram account'] = '已成功登录到您的Instagram相册';
$lang['(%d photos)'] = '(%d张图片)';
$lang['API not authenticated'] = 'API未通过验证';
$lang['Begin transfer'] = '开始转换';
$lang['Fill these fields from Instagram datas'] = '用来自Instagram的数据填写这些字段';
$lang['Instagram logins'] = 'Flickr登录';
$lang['How do I get my Instagram Client ID?'] = '我如何获得Instagram API key？';
$lang['Import'] = '导入';
