 ...
 */
abstract class Instagram_Core_BaseObjectAbstract {
     ...
     * @param Instagram_Core_Proxy $proxy Object's proxy
     * @access public
     */
    public function __construct( $data, Instagram_Core_Proxy $proxy = null ) {
        $this->setData( $data );
        $this->proxy = $proxy;
    }
     ...
     * 
     * @param Instagram_Core_Proxy $proxy Proxy object
     * @access public
     */
    public function setProxy( Instagram_Core_Proxy $proxy ) {
        $this->proxy = $proxy;
    }
