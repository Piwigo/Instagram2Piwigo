...
include_once(INSTAGRAM_ROOT.'/Collection/LikedMediaCollection.php');
include_once(INSTAGRAM_ROOT.'/Collection/UserCollection.php');
include_once(INSTAGRAM_ROOT.'/User.php');
include_once(INSTAGRAM_ROOT.'/Comment.php');
 ...
 */
class Instagram_CurrentUser extends Instagram_User {
     ...
     *
     * @param Instagram_Media $media Media to query for a like from the current user
     * @access public
     */
    public function likes( Instagram_Media $media ) {
        return
     ...
     *
     * @param Instagram_Media|string $media Media to add a like to from the current Instagram_User
     * @access public
     */
    public function addLike( $media ) {
        if ( $media instanceof Instagram_Media ) {
            $media = $media->getId();
        }
     ...
     *
     * @param Instagram_Media|string $media Media to delete a like to from the current user
     * @access public
     */
     ...
     * Delete a comment
     *
     * @param Instagram_Media|string Media to delete a comment from
    ...
    public function deleteMediaComment( $media, $comment ) {
        ...
        if ( $comment instanceof Instagram_Comment ) {
     ...
     *
     * @see Instagram_CurrentUser::follow
     * @see Instagram_CurrentUser::unFollow
     * @see Instagram_CurrentUser::getRelationship
     * @see Instagram_CurrentUser::approveFollowRequest
     * @see Instagram_CurrentUser::ignoreFollowRequest
     * @see Instagram_CurrentUser::block
     * @see Instagram_CurrentUser::unblock
     *
     * @param Instagram_User|string Instagram_User object or user id whose relationship you'd like to update
     * @access protected
     */
    protected function updateRelationship( $user ) {
        if ( $user instanceof Instagram_User ) {
            $user = $user->getId();
        }
     ...
     *
     * @param Instagram_User|string Instagram_User object or Instagram_User id who should be followed
     * @return boolean
     */
     ...
     * Approve follower
     *
     * @param Instagram_User|string $user Instagram_User object or Instagram_User id who should be approved for following
     * @return boolean
     */
     ...
     * Ignore follower
     *
     * @param Instagram_User|string $user Instagram_User object or user id who should be ignored
     * @return boolean
     */
     ...
     * Unfollow user
     *
     * @param Instagram_User|string $user Instagram_User object or user id who should be unfollowed
     * @return boolean
     */
     ...
     * Block user
     *
     * @param Instagram_User|string $user Instagram_User object or user id who should be blocked
     * @return boolean
     */
     ...
     * Unblock user
     *
     * @param Instagram_User|string $user Instagram_User object or user id who should be unblocked
     * @return boolean
     */
     ...
     *
     * @param Instagram_User|string $user Instagram_User object or user id to get the relationship details of
     * @return StdClass
     */
    ...
    public function getFollowRequests() {
        return new Instagram_Collection_UserCollection( $this->proxy->getFollowRequests(), $this->proxy );
    }
     ...
     * Check following status
     *
     * Check if hte current Instagram_User is following a Instagram_User
     *
     * @param Instagram_User|string $user Instagram_User object or user id to check the following status of
     * @return boolean
     */
     ...
     *
     * @param Instagram_User|string $user Instagram_User object or user id to check the followed by status of
     * @return boolean
     */
    ...
    public function getFeed( array $params = null ) {
        return new Instagram_Collection_MediaCollection( $this->proxy->getFeed( $params ), $this->proxy );
    }

    /**
     * Get the current user's liked media
     *
     * This can be paginated with the next_max_like_id param obtained from Instagram_Collection_MediaCollection->getNext()
     *
     * @param array $params Optional params to pass to the endpoint
     * @return Instagram_Collection_MediaCollection
     * @access public
    ...
    public function getLikedMedia( array $params = null ) {
        return  new Instagram_Collection_LikedMediaCollection( $this->proxy->getLikedMedia( $params ), $this->proxy );
    }
