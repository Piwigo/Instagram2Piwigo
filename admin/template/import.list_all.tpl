...
function performImport(photo, album, fills) {
  queuedManager.add({
    ...
    dataType: 'json',
    url: 'ws.php',
    data: { method: 'pwg.images.addInstagram', id: photo, category: album, fills: fills, format: 'json' },
...
{html_head}
<style type="text/css">
.thumbnails .wrap2 {ldelim} width:128px; height:128px; }
.thumbnail {ldelim} width:100px; }
</style>
{/html_head}
